    ...
    for b = 1:num_blocks
        ...
        for image = imgStartIndex:imgEndIndex % self condition
            ...
            if choice ~= "NAN"
                ...
                save_img_dir = mkdir(fullfile(sprintf("../../3_results/1_et_processing/3_heatmaps/1_heatmapMatrices/3_singleSubjectMatrices/sub-%s/mot-%s/", sub, mot)));
                save_img_path = fullfile(sprintf("../../3_results/1_et_processing/3_heatmaps/1_heatmapMatrices/3_singleSubjectMatrices/sub-%s/mot-%s/", sub, mot));
